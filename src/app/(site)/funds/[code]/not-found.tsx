...
export default function FundNotFound() {
  return (
    <div className="flex flex-col flex-1 items-center justify-center px-4 py-20 text-center">
      <h1 className="text-2xl font-extrabold text-slate-900 mb-2">Fund not found</h1>
      <p className="text-slate-600 mb-6 max-w-md">
        This scheme is not in our curated list, or NAV data could not be loaded.
      </p>
      <Link
        href="/#curated"
