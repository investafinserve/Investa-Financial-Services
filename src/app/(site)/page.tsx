        ...
        <section className="relative mx-auto flex max-w-6xl flex-col-reverse gap-8 px-4 py-8 sm:px-6 md:flex-row md:items-center md:py-12 lg:py-16">
          <div className="w-full md:w-1/2 space-y-5 relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-100 text-xs font-bold text-blue-700 mb-1 shadow-sm">
              <span className="w-2 h-2 rounded-full bg-blue-500 shadow-[0_0_4px_#3b82f6]" />
            ...
            <div className="space-y-3">
              <h1 className="text-4xl sm:text-5xl md:text-5xl lg:text-7xl font-extrabold leading-[1.15] text-slate-900 drop-shadow-sm tracking-tight">
                Confused by <br />
                <span className="opacity-40 line-through decoration-red-500/60 decoration-4 inline-block transform -rotate-1">
                  Market Noise?
                </span>
                <br />
            ...
            <div className="space-y-2 text-sm sm:text-lg text-slate-600 max-w-lg font-medium">
              <p className="border-l-4 border-blue-500 pl-4 py-1 bg-gradient-to-r from-blue-50 to-transparent">
                Personalized mutual fund distribution meant for the new generation.
              </p>
              <p className="border-l-4 border-purple-500 pl-4 py-1 bg-gradient-to-r from-purple-50 to-transparent">
                Start right, grow consistently, and achieve your dreams.
              </p>
            </div>
              ...
              <div className="flex items-center justify-center gap-3 text-slate-500 font-medium">
                ...
                >
                  <div className="p-2.5 rounded-full bg-slate-100 group relative overflow-hidden shadow-sm">
                    ...
                    <div className="absolute inset-0 bg-blue-100 translate-y-[100%] group-hover:translate-y-0 transition-transform" />
                  </div>
                  +91 99091 11020
                </a>
              </div>
          ...
          <div className="w-full md:w-1/2 lg:w-[55%] flex justify-center md:justify-end relative z-10">
            <div className="relative w-full max-w-lg md:max-w-xl lg:max-w-2xl mt-8 md:mt-0">
              <div className="absolute inset-0 bg-gradient-to-tr from-blue-200 to-purple-200 rounded-full blur-3xl animate-pulse-glow opacity-60" />
              ...
              <div
                className="absolute top-[42%] -left-3 sm:-left-10 z-30 glass shadow-md sm:shadow-lg px-3 py-2 sm:px-5 sm:py-3 rounded-xl sm:rounded-2xl flex items-center gap-2 sm:gap-3 animate-float"
              ...
              <div
                className="absolute bottom-[16%] right-2 sm:-right-4 z-30 glass shadow-md sm:shadow-lg px-3 py-2 sm:px-5 sm:py-3 rounded-xl sm:rounded-2xl flex items-center gap-2 sm:gap-3 animate-float"
        ...
        <section id="learn" className="relative mx-auto max-w-6xl px-4 py-12 sm:px-6 md:py-16">
          <div className="text-center space-y-4 mb-10">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto text-sm md:text-base font-medium">
              Dive into our curated YouTube guides designed for youngsters starting their investment journey. Gain
              insights, avoid pitfalls, and build a strong financial mindset.
            </p>
          </div>
